              ...
              <ul class="sidebar-menu">
                  <li class="<?php if(isset($Result['menu']) && $Result['menu'] == 'dashboard'):?>active<?php endif;?>">
					...
					<li class="treeview <?php if(isset($Result['menu']) && $Result['menu'] == 'settings'):?>active<?php endif;?>">
						...
						<ul class="treeview-menu">
						    <li <?php if(isset($Result['submenu']) && $Result['submenu'] == 'general'):?>class="active"<?php endif;?>><a href="<?=__url('system/list')?>"><i class="fa fa-angle-double-right"></i><?=__t('pagelayout/pagelayout','General')?></a></li>
