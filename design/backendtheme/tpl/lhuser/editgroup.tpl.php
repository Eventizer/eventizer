<div class="col-xs-12">
	<div class="box box-primary">
		...
		<form action="<?=__url('user/editgroup')?>/<?=$groupData->id?>" method="post">
			<div class="box-body">
				<?php include_once(erLhcoreClassDesign::designtpl('lhuser/form/group.tpl.php'));?>
			</div>
	...
	<div class="box box-primary">
	    	...
	    	<form action="<?=__url('user/editgroup')?>/<?=$groupData->id?>" method="post">	 
				...
				<div class="box-footer">
					...
					<?php endif; ?>
					<a class="btn btn-primary" data-toggle="modal" data-target="#modal" href="<?=__url('user/groupassignuser')?>/<?=$groupData->id?>"><?=__t('system/button','Assign user')?></a>					
				</div>
		...
		<div class="box-header">
			...
			<form action="<?=__url('user/editgroup')?>/<?=$groupData->id?>" method="post">
				...
				<div class="box-footer">
					...
					<?php endif; ?>	
					<a class="btn btn-primary"  data-toggle="modal" data-target="#modalRole"  href="<?=__url('user/groupassignrole')?>/<?=$groupData->id?>"><?=__t('user/editgroup','Assign role')?></a>
				</div>
