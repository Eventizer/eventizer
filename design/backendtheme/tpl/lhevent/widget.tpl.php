<div class="col-xs-12">
    <div class="box  box-primary">
       ...
       <div class="box-body table-responsive">
            ...
            <form enctype="multipart/form-data" action="<?=__url('event/widget')?>" method="post" autocomplete="off">
    			<div class="box-body">
    				...
    				<?php include_once(erLhcoreClassDesign::designtpl('lhevent/form/widget.tpl.php'));?>
    			</div>
