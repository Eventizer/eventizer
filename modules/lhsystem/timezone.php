...
$Result['title'] =  erTranslationClassLhTranslation::getInstance()->getTranslation('system/timezone','Time zone');
$Result['small_title'] =  __t('system/timezone','Change your time zone settings');
