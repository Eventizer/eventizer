...
$Result['title'] = array(
    'title' => __t('permission/newrole', 'New role'),
    'small_title' => __t('permission/newrole', 'Create new role')
);
...
$Result['path'] = array(
    array(
        'url' => erLhcoreClassDesign::baseurl('permission/roles'),
        'title' => erTranslationClassLhTranslation::getInstance()->getTranslation('permission/newrole', 'List of roles')
    ),
    array(
        'title' => erTranslationClassLhTranslation::getInstance()->getTranslation('permission/newrole', 'New role')
    )
)?>
