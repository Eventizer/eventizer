...
$tpl = erLhcoreClassTemplate::getInstance('lharticleadmin/managecategories.tpl.php');
...
$Result['path'] = array(array('url' => __url('articleadmin/managecategories'),'title' => __t('articleadmin/staticlist','Manage categories')));

if ($category->parent_id > 0){
    $Result['path'][] = array('url' => __url('articleadmin/managecategories').'/'.$category->parent_id,'title' => $category->parent->name);
};

$Result['path'][] = array('title' => $category->name);